...
(function ($) {
  ...
  var defaultOptions = {
    tagClass: function (item) {
      return 'border  badge badge-light rounded shadow-sm mx-1';
    },
    focusClass: 'focus',
  ...
  TagsInput.prototype = {
    ...
    add: function (item, dontPushVal, options) {
      ...
      var $tag = $('<span style="font-size:13px;" class="' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + htmlEncode(itemText) + '<span data-role="remove" ></span></span>');
      $tag.data('item', item);
